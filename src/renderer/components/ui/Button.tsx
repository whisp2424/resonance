...
export default function Button({
    ...
    const className = clsx(
        "relative inline-flex items-center justify-center gap-1.5 rounded-lg px-4 py-1 text-sm font-medium transition duration-150 ease-out disabled:pointer-events-none disabled:opacity-50",
        variants[variant],
    );
