...
export default function SettingsView() {
    ...
    return (
        <>
            <div className="pointer-events-none fixed h-(--spacing-titlebar-height) w-full border-b border-neutral-300 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900" />
